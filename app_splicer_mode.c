...
static VOID _splicer_vipss_rx_mux_cfg(UINT8 u8_vipss_sel, SPLICER_APP_T *pst_app_splicer_dev)
{
	//vipss rx sel    
	gst_splicer_vipss_dev[u8_vipss_sel].st_vipss_mux_dev.u8_src_module = g_u8_misc_module_rx[g_u8_HD_RX_PROT[pst_app_splicer_dev->u8_src_sel]];
	...
	if(g_st_hd_rx[pst_app_splicer_dev->u8_src_sel].u8_color_space == HD_COLORSPACE_YCBCR420)
	{
		//vipss rx csc config
		...
		g_stVideo_HDRx_Timing[pst_app_splicer_dev->u8_src_sel].u16_vactive = g_st_hd_rx[pst_app_splicer_dev->u8_src_sel].st_rx_video_timing.u16_vactive / 2;
	}
	else
	{
		//vipss rx csc config
		g_st_vipss_csc[u8_vipss_sel].u8_sel = g_u8_csc_idx[u8_vipss_sel];
		g_st_vipss_csc[u8_vipss_sel].st_csc_config_param.csc_in_colorspace = g_st_hd_rx[pst_app_splicer_dev->u8_src_sel].u8_color_space;
		g_st_vipss_csc[u8_vipss_sel].st_csc_config_param.csc_out_colorspace = CHIP_INTERNAL_PROCESS_COLORSPACE;
		api_csc_rx_set(&g_st_vipss_csc[u8_vipss_sel]);
		
		if(g_st_hd_rx[pst_app_splicer_dev->u8_src_sel].st_rx_video_timing.u8_polarity % 2 == 0)
		{
			switch(g_st_hd_rx[pst_app_splicer_dev->u8_src_sel].st_rx_video_timing.u16_vactive)
			{
				case 1080:
					//vipss mux config
					...
					g_stVideo_HDRx_Timing[pst_app_splicer_dev->u8_src_sel].u16_vactive = 1080;
					break;
				case 480:
					//vipss mux config
					api_misc_vipss_mux_cfg(u8_vipss_sel, MISC_VIPSS_MUXTYPE_8);       //< CSC ->DEINT-> SDN -> VWDMA1
					...
					api_deint_init(&g_st_deint_dev);
					api_deint_config(&g_st_deint_dev);
					g_stVideo_HDRx_Timing[pst_app_splicer_dev->u8_src_sel].u16_hactive = g_st_hd_rx[pst_app_splicer_dev->u8_src_sel].st_rx_video_timing.u16_hactive / 2;
					g_stVideo_HDRx_Timing[pst_app_splicer_dev->u8_src_sel].u16_vactive = 480;
					break;
				case 576:
					//vipss mux config
					api_misc_vipss_mux_cfg(u8_vipss_sel, MISC_VIPSS_MUXTYPE_8);       //< CSC ->DEINT-> SDN -> VWDMA1
					...
					api_deint_config(&g_st_deint_dev);
					g_stVideo_HDRx_Timing[pst_app_splicer_dev->u8_src_sel].u16_hactive = g_st_hd_rx[pst_app_splicer_dev->u8_src_sel].st_rx_video_timing.u16_hactive / 2;
					g_stVideo_HDRx_Timing[pst_app_splicer_dev->u8_src_sel].u16_vactive = 576;
					break;
				default:
		...
		else
		{
			if(g_st_hd_rx[pst_app_splicer_dev->u8_src_sel].st_rx_video_timing.u8_polarity % 2 == 0)
			{
				g_st_deint_dev.b_deint_en = MS_FALSE;
				api_deint_config(&g_st_deint_dev);
				g_stVideo_HDRx_Timing[pst_app_splicer_dev->u8_src_sel].u16_hactive = g_st_hd_rx[pst_app_splicer_dev->u8_src_sel].st_rx_video_timing.u16_hactive;
				g_stVideo_HDRx_Timing[pst_app_splicer_dev->u8_src_sel].u16_vactive = g_st_hd_rx[pst_app_splicer_dev->u8_src_sel].st_rx_video_timing.u16_vactive / 2;
			}
			//vipss mux config
			api_misc_vipss_mux_cfg(u8_vipss_sel, MISC_VIPSS_MUXTYPE_4);       //< CSC -> SDN -> VWDMA1
...
static VOID _splicer_vipss_cfg(UINT8 u8_vipss_sel, SPLICER_APP_T *pst_app_splicer_dev)
{
	...
	gst_splicer_vipss_dev[u8_vipss_sel].st_splicer_sdn_dev.st_video_size.st_InRect.u16_h = pst_app_splicer_dev->tSdn_InSize.u16_h;
	gst_splicer_vipss_dev[u8_vipss_sel].st_splicer_sdn_dev.st_video_size.st_InRect.u16_v = pst_app_splicer_dev->tSdn_InSize.u16_v;
	gst_splicer_vipss_dev[u8_vipss_sel].st_splicer_sdn_dev.st_video_size.st_MemRect.u16_h = pst_app_splicer_dev->tSdn_MemSize.u16_h;
	gst_splicer_vipss_dev[u8_vipss_sel].st_splicer_sdn_dev.st_video_size.st_MemRect.u16_v = pst_app_splicer_dev->tSdn_MemSize.u16_v;
	...
	gst_splicer_vipss_dev[u8_vipss_sel].st_splicer_vwdma_dev.st_vwdma_in_size.u16_h_size = pst_app_splicer_dev->tSdn_MemSize.u16_h;
	gst_splicer_vipss_dev[u8_vipss_sel].st_splicer_vwdma_dev.st_vwdma_in_size.u16_v_size = pst_app_splicer_dev->tSdn_MemSize.u16_v;
	...
	gst_splicer_vipss_dev[u8_vipss_sel].st_splicer_vwdma_dev.st_vwdma_start_addr.u32_dma_start_addr_0 = pst_app_splicer_dev->st_wdma_addr.u32_dma_start_addr_0;
	gst_splicer_vipss_dev[u8_vipss_sel].st_splicer_vwdma_dev.st_vwdma_start_addr.u32_dma_start_addr_1 = pst_app_splicer_dev->st_wdma_addr.u32_dma_start_addr_1;      
	gst_splicer_vipss_dev[u8_vipss_sel].st_splicer_vwdma_dev.st_vwdma_start_addr.u32_dma_start_addr_2 = pst_app_splicer_dev->st_wdma_addr.u32_dma_start_addr_2;    
...
static VOID _splicer_mode_cfg(SPLICER_APP_T *pst_app_splicer_dev)
{
	switch(pst_app_splicer_dev->u8_splicer_mode)
	{
		case SPLICER_MODE_1X1:
			pst_app_splicer_dev->tSdn_MemSize.u16_h = return_minof_three(pst_app_splicer_dev->tSdn_InSize.u16_h, g_stVideo_HDTx_Timing.u16_hactive, MEMORY_4K_H_SIZE_MAX);
			pst_app_splicer_dev->tSdn_MemSize.u16_v = return_minof_three(pst_app_splicer_dev->tSdn_InSize.u16_v, g_stVideo_HDTx_Timing.u16_vactive, MEMORY_4K_V_SIZE_MAX);
			...
			if(pst_app_splicer_dev->tSdn_MemSize.u16_v < g_stVideo_HDTx_Timing.u16_vactive * 2 && pst_app_splicer_dev->tSdn_MemSize.u16_h > 2048)
			{
				pst_app_splicer_dev->tSdn_MemSize.u16_h = 2048;
			}
		...
		case SPLICER_MODE_2X2:
			pst_app_splicer_dev->tSdn_MemSize.u16_h = return_minof_three(pst_app_splicer_dev->tSdn_InSize.u16_h, 2 * g_stVideo_HDTx_Timing.u16_hactive, MEMORY_4K_H_SIZE_MAX);
			pst_app_splicer_dev->tSdn_MemSize.u16_v = return_minof_three(pst_app_splicer_dev->tSdn_InSize.u16_v, 2 * g_stVideo_HDTx_Timing.u16_vactive, MEMORY_4K_V_SIZE_MAX);
			...
			if(u8_h_border_fusion * 8 > pst_app_splicer_dev->tSdn_MemSize.u16_h / 4)
				u8_h_border_fusion = pst_app_splicer_dev->tSdn_MemSize.u16_h / 4 / 8;
			if(u8_v_border_fusion * 8 > pst_app_splicer_dev->tSdn_MemSize.u16_v / 4)
				u8_v_border_fusion = pst_app_splicer_dev->tSdn_MemSize.u16_v / 4 / 8;
			
			pst_app_splicer_dev->st_winborder[0].left = 0;
			pst_app_splicer_dev->st_winborder[0].right = pst_app_splicer_dev->tSdn_MemSize.u16_h / 2 - u8_h_border_fusion * 8;
			pst_app_splicer_dev->st_winborder[0].top = 0;
			pst_app_splicer_dev->st_winborder[0].bottom = pst_app_splicer_dev->tSdn_MemSize.u16_v / 2 - u8_v_border_fusion * 8;
			
			pst_app_splicer_dev->st_winborder[1].left = pst_app_splicer_dev->tSdn_MemSize.u16_h / 2 + u8_h_border_fusion * 8;
			pst_app_splicer_dev->st_winborder[1].right = pst_app_splicer_dev->tSdn_MemSize.u16_h;
			pst_app_splicer_dev->st_winborder[1].top = 0;
			pst_app_splicer_dev->st_winborder[1].bottom = pst_app_splicer_dev->tSdn_MemSize.u16_v / 2 - u8_v_border_fusion * 8;
			
			pst_app_splicer_dev->st_winborder[2].left = 0;
			pst_app_splicer_dev->st_winborder[2].right = pst_app_splicer_dev->tSdn_MemSize.u16_h / 2 - u8_h_border_fusion * 8;
			pst_app_splicer_dev->st_winborder[2].top = pst_app_splicer_dev->tSdn_MemSize.u16_v / 2 + u8_v_border_fusion * 8;
			pst_app_splicer_dev->st_winborder[2].bottom = pst_app_splicer_dev->tSdn_MemSize.u16_v;
			
			pst_app_splicer_dev->st_winborder[3].left = pst_app_splicer_dev->tSdn_MemSize.u16_h / 2 + u8_h_border_fusion * 8;
			pst_app_splicer_dev->st_winborder[3].right = pst_app_splicer_dev->tSdn_MemSize.u16_h;
			pst_app_splicer_dev->st_winborder[3].top = pst_app_splicer_dev->tSdn_MemSize.u16_v / 2 + u8_v_border_fusion * 8;
			pst_app_splicer_dev->st_winborder[3].bottom = pst_app_splicer_dev->tSdn_MemSize.u16_v;
		...
		case SPLICER_MODE_1X2:
			...
			if(pst_app_splicer_dev->tSdn_MemSize.u16_v < g_stVideo_HDTx_Timing.u16_vactive && pst_app_splicer_dev->tSdn_MemSize.u16_h > 2048)
			{
				pst_app_splicer_dev->tSdn_MemSize.u16_h = 2048;
			}
			...
			pst_app_splicer_dev->st_winborder[1].right = pst_app_splicer_dev->tSdn_MemSize.u16_h;
			pst_app_splicer_dev->st_winborder[1].top = 0;
			pst_app_splicer_dev->st_winborder[1].bottom = pst_app_splicer_dev->tSdn_MemSize.u16_v;
		...
		case SPLICER_MODE_1X3:
			pst_app_splicer_dev->tSdn_MemSize.u16_h = return_minof_three(pst_app_splicer_dev->tSdn_InSize.u16_h, 3 * g_stVideo_HDTx_Timing.u16_hactive, MEMORY_4K_H_SIZE_MAX);
			pst_app_splicer_dev->tSdn_MemSize.u16_v = return_minof_three(pst_app_splicer_dev->tSdn_InSize.u16_v, g_stVideo_HDTx_Timing.u16_vactive, MEMORY_4K_V_SIZE_MAX);
			...
			if(u8_h_border_fusion * 8 > pst_app_splicer_dev->tSdn_MemSize.u16_h / 6)
				u8_h_border_fusion = pst_app_splicer_dev->tSdn_MemSize.u16_h / 6 / 8;
			
			pst_app_splicer_dev->st_winborder[0].left = 0;
			pst_app_splicer_dev->st_winborder[0].right = pst_app_splicer_dev->tSdn_MemSize.u16_h / 3 - u8_h_border_fusion * 8;
			pst_app_splicer_dev->st_winborder[0].top = 0;
			pst_app_splicer_dev->st_winborder[0].bottom = pst_app_splicer_dev->tSdn_MemSize.u16_v;
			
			pst_app_splicer_dev->st_winborder[1].left = pst_app_splicer_dev->tSdn_MemSize.u16_h / 3 + u8_h_border_fusion * 8;
			pst_app_splicer_dev->st_winborder[1].right = pst_app_splicer_dev->tSdn_MemSize.u16_h / 3 * 2 - u8_h_border_fusion * 8;
			pst_app_splicer_dev->st_winborder[1].top = 0;
			pst_app_splicer_dev->st_winborder[1].bottom = pst_app_splicer_dev->tSdn_MemSize.u16_v;
			
			pst_app_splicer_dev->st_winborder[2].left = pst_app_splicer_dev->tSdn_MemSize.u16_h / 3 * 2 + u8_h_border_fusion * 8;
			pst_app_splicer_dev->st_winborder[2].right = pst_app_splicer_dev->tSdn_MemSize.u16_h;
		...
		case SPLICER_MODE_1X4:
			pst_app_splicer_dev->tSdn_MemSize.u16_h = return_minof_three(pst_app_splicer_dev->tSdn_InSize.u16_h, 4 * g_stVideo_HDTx_Timing.u16_hactive, MEMORY_4K_H_SIZE_MAX);
			pst_app_splicer_dev->tSdn_MemSize.u16_v = return_minof_three(pst_app_splicer_dev->tSdn_InSize.u16_v, g_stVideo_HDTx_Timing.u16_vactive, MEMORY_4K_V_SIZE_MAX);
			...
			if(u8_h_border_fusion * 8 > pst_app_splicer_dev->tSdn_MemSize.u16_h / 8)
				u8_h_border_fusion = pst_app_splicer_dev->tSdn_MemSize.u16_h / 8 / 8;
			
			pst_app_splicer_dev->st_winborder[0].left = 0;
			pst_app_splicer_dev->st_winborder[0].right = pst_app_splicer_dev->tSdn_MemSize.u16_h / 4 - u8_h_border_fusion * 8;
			pst_app_splicer_dev->st_winborder[0].top = 0;
			pst_app_splicer_dev->st_winborder[0].bottom = pst_app_splicer_dev->tSdn_MemSize.u16_v;
			
			pst_app_splicer_dev->st_winborder[1].left = pst_app_splicer_dev->tSdn_MemSize.u16_h / 4 + u8_h_border_fusion * 8;
			pst_app_splicer_dev->st_winborder[1].right = pst_app_splicer_dev->tSdn_MemSize.u16_h / 2 - u8_h_border_fusion * 8;
			pst_app_splicer_dev->st_winborder[1].top = 0;
			pst_app_splicer_dev->st_winborder[1].bottom = pst_app_splicer_dev->tSdn_MemSize.u16_v;
			
			pst_app_splicer_dev->st_winborder[2].left = pst_app_splicer_dev->tSdn_MemSize.u16_h / 2 + u8_h_border_fusion * 8;
			pst_app_splicer_dev->st_winborder[2].right = pst_app_splicer_dev->tSdn_MemSize.u16_h / 4 * 3 - u8_h_border_fusion * 8;
			pst_app_splicer_dev->st_winborder[2].top = 0;
			pst_app_splicer_dev->st_winborder[2].bottom = pst_app_splicer_dev->tSdn_MemSize.u16_v;
			
			pst_app_splicer_dev->st_winborder[3].left = pst_app_splicer_dev->tSdn_MemSize.u16_h / 4 * 3 + u8_h_border_fusion * 8;
			pst_app_splicer_dev->st_winborder[3].right = pst_app_splicer_dev->tSdn_MemSize.u16_h;
		...
		case SPLICER_MODE_2X1:
			...
			pst_app_splicer_dev->st_winborder[1].right = pst_app_splicer_dev->tSdn_MemSize.u16_h;
			pst_app_splicer_dev->st_winborder[1].top = pst_app_splicer_dev->tSdn_MemSize.u16_v / 2 + u8_v_border_fusion * 8;
			pst_app_splicer_dev->st_winborder[1].bottom = pst_app_splicer_dev->tSdn_MemSize.u16_v;
		...
		case SPLICER_MODE_3X1:
			pst_app_splicer_dev->tSdn_MemSize.u16_h = return_minof_three(pst_app_splicer_dev->tSdn_InSize.u16_h, g_stVideo_HDTx_Timing.u16_hactive, MEMORY_4K_H_SIZE_MAX);
			pst_app_splicer_dev->tSdn_MemSize.u16_v = return_minof_three(pst_app_splicer_dev->tSdn_InSize.u16_v, 3 * g_stVideo_HDTx_Timing.u16_vactive, MEMORY_4K_V_SIZE_MAX);
		
			if(pst_app_splicer_dev->tSdn_InSize.u16_v > pst_app_splicer_dev->tSdn_MemSize.u16_v && pst_app_splicer_dev->tSdn_MemSize.u16_h > 2048)
			{
				pst_app_splicer_dev->tSdn_MemSize.u16_h = 2048;
			}
			if(pst_app_splicer_dev->tSdn_MemSize.u16_v < g_stVideo_HDTx_Timing.u16_vactive * 3 && pst_app_splicer_dev->tSdn_MemSize.u16_h > 2048)
			{
				pst_app_splicer_dev->tSdn_MemSize.u16_h = 2048;
			}
			...
			if(u8_v_border_fusion * 8 > pst_app_splicer_dev->tSdn_MemSize.u16_v / 6)
				u8_v_border_fusion = pst_app_splicer_dev->tSdn_MemSize.u16_v / 6 / 8;
			
			pst_app_splicer_dev->st_winborder[0].left = 0;
			pst_app_splicer_dev->st_winborder[0].right = pst_app_splicer_dev->tSdn_MemSize.u16_h;
			pst_app_splicer_dev->st_winborder[0].top = 0;
			pst_app_splicer_dev->st_winborder[0].bottom = pst_app_splicer_dev->tSdn_MemSize.u16_v / 3 - u8_v_border_fusion * 8;
			
			pst_app_splicer_dev->st_winborder[1].left = 0;
			pst_app_splicer_dev->st_winborder[1].right = pst_app_splicer_dev->tSdn_MemSize.u16_h;
			pst_app_splicer_dev->st_winborder[1].top = pst_app_splicer_dev->tSdn_MemSize.u16_v / 3 + u8_v_border_fusion * 8;
			pst_app_splicer_dev->st_winborder[1].bottom = pst_app_splicer_dev->tSdn_MemSize.u16_v / 3 * 2 - u8_v_border_fusion * 8;
			
			pst_app_splicer_dev->st_winborder[2].left = 0;
			pst_app_splicer_dev->st_winborder[2].right = pst_app_splicer_dev->tSdn_MemSize.u16_h;
			pst_app_splicer_dev->st_winborder[2].top = pst_app_splicer_dev->tSdn_MemSize.u16_v / 3 * 2 - u8_v_border_fusion * 8;
			pst_app_splicer_dev->st_winborder[2].bottom = pst_app_splicer_dev->tSdn_MemSize.u16_v;
		...
		case SPLICER_MODE_4X1:
			pst_app_splicer_dev->tSdn_MemSize.u16_h = return_minof_three(pst_app_splicer_dev->tSdn_InSize.u16_h, g_stVideo_HDTx_Timing.u16_hactive, MEMORY_4K_H_SIZE_MAX);
			pst_app_splicer_dev->tSdn_MemSize.u16_v = return_minof_three(pst_app_splicer_dev->tSdn_InSize.u16_v, 4 * g_stVideo_HDTx_Timing.u16_vactive, MEMORY_4K_V_SIZE_MAX);
		
			if(pst_app_splicer_dev->tSdn_InSize.u16_v > pst_app_splicer_dev->tSdn_MemSize.u16_v && pst_app_splicer_dev->tSdn_MemSize.u16_h > 2048)
			{
				pst_app_splicer_dev->tSdn_MemSize.u16_h = 2048;
			}
			if(pst_app_splicer_dev->tSdn_MemSize.u16_v < g_stVideo_HDTx_Timing.u16_vactive * 4 && pst_app_splicer_dev->tSdn_MemSize.u16_h > 2048)
			{
				pst_app_splicer_dev->tSdn_MemSize.u16_h = 2048;
			}
			...
			if(u8_v_border_fusion * 8 > pst_app_splicer_dev->tSdn_MemSize.u16_v / 8)
				u8_v_border_fusion = pst_app_splicer_dev->tSdn_MemSize.u16_v / 8 / 8;
			
			pst_app_splicer_dev->st_winborder[0].left = 0;
			pst_app_splicer_dev->st_winborder[0].right = pst_app_splicer_dev->tSdn_MemSize.u16_h;
			pst_app_splicer_dev->st_winborder[0].top = 0;
			pst_app_splicer_dev->st_winborder[0].bottom = pst_app_splicer_dev->tSdn_MemSize.u16_v / 4 - u8_v_border_fusion * 8;
			
			pst_app_splicer_dev->st_winborder[1].left = 0;
			pst_app_splicer_dev->st_winborder[1].right = pst_app_splicer_dev->tSdn_MemSize.u16_h;
			pst_app_splicer_dev->st_winborder[1].top = pst_app_splicer_dev->tSdn_MemSize.u16_v / 4 + u8_v_border_fusion * 8;
			pst_app_splicer_dev->st_winborder[1].bottom = pst_app_splicer_dev->tSdn_MemSize.u16_v / 2 - u8_v_border_fusion * 8;
			
			pst_app_splicer_dev->st_winborder[2].left = 0;
			pst_app_splicer_dev->st_winborder[2].right = pst_app_splicer_dev->tSdn_MemSize.u16_h;
			pst_app_splicer_dev->st_winborder[2].top = pst_app_splicer_dev->tSdn_MemSize.u16_v / 2 + u8_v_border_fusion * 8;
			pst_app_splicer_dev->st_winborder[2].bottom = pst_app_splicer_dev->tSdn_MemSize.u16_v / 4 * 3 - u8_v_border_fusion * 8;
			
			pst_app_splicer_dev->st_winborder[3].left = 0;
			pst_app_splicer_dev->st_winborder[3].right = pst_app_splicer_dev->tSdn_MemSize.u16_h;
			pst_app_splicer_dev->st_winborder[3].top = pst_app_splicer_dev->tSdn_MemSize.u16_v / 4 * 3 + u8_v_border_fusion * 8;
			pst_app_splicer_dev->st_winborder[3].bottom = pst_app_splicer_dev->tSdn_MemSize.u16_v;
...
VOID splicer_video_mute(UINT8 u8_path, BOOL b_mute)
{
	UINT8 u8_i = 0;
	BOOL b_int;
	if(u8_path == gst_splicer_app_dev.u8_src_sel)
	{
		for(u8_i = 0; u8_i < 4; u8_i++)
		{
...
VOID app_splicer_rx_smeless_switch(SPLICER_APP_T *pst_app_splicer_dev)
{
	...
	_splicer_vipss_rx_mux_cfg(g_u8_splicer_vipss_sel, pst_app_splicer_dev);
	pst_app_splicer_dev->tSdn_InSize.u16_h = g_stVideo_HDRx_Timing[pst_app_splicer_dev->u8_src_sel].u16_hactive > 0 ? g_stVideo_HDRx_Timing[pst_app_splicer_dev->u8_src_sel].u16_hactive : 1920;
	pst_app_splicer_dev->tSdn_InSize.u16_v = g_stVideo_HDRx_Timing[pst_app_splicer_dev->u8_src_sel].u16_vactive > 0 ? g_stVideo_HDRx_Timing[pst_app_splicer_dev->u8_src_sel].u16_vactive : 1080;
	Vipss_Mapping_Rx[g_u8_splicer_vipss_sel] = g_u8_HD_RX_PROT[pst_app_splicer_dev->u8_src_sel];	
	_splicer_mode_cfg(&gst_splicer_app_dev);
	switch(pst_app_splicer_dev->u8_splicer_mode)
	{
		case SPLICER_MODE_1X1:
		case SPLICER_MODE_2X2: 
	...
	_splicer_audio_cfg(pst_app_splicer_dev->u8_src_sel);
	g_bOSDShown = MS_TRUE;
...
{      
	...
	switch(pst_app_splicer_dev->u8_splicer_mode)
	{
		case SPLICER_MODE_1X1:
			...
			_splicer_mode_cfg(&gst_splicer_app_dev); 
			_app_video_splicer_mixer_cfg(VIDEO_MIXER_1, g_u8_mixer_layer_src[0]);
			_app_video_splicer_mixer_cfg(VIDEO_MIXER_2, g_u8_mixer_layer_src[0]);
			_app_video_splicer_mixer_cfg(VIDEO_MIXER_3, g_u8_mixer_layer_src[0]);
			_app_video_splicer_mixer_cfg(VIDEO_MIXER_4, g_u8_mixer_layer_src[0]);
			_splicer_video_unfreeze(g_u8_splicer_vipss_sel); 
			break;
		case SPLICER_MODE_2X2: 
		case SPLICER_MODE_4X1:
...
VOID app_splicer_process(SPLICER_APP_T *pst_app_splicer_dev)
{
	_splicer_vipss_rx_mux_cfg(g_u8_splicer_vipss_sel, pst_app_splicer_dev);
	pst_app_splicer_dev->tSdn_InSize.u16_h = g_stVideo_HDRx_Timing[pst_app_splicer_dev->u8_src_sel].u16_hactive > 0 ? g_stVideo_HDRx_Timing[pst_app_splicer_dev->u8_src_sel].u16_hactive : 1920;
	pst_app_splicer_dev->tSdn_InSize.u16_v = g_stVideo_HDRx_Timing[pst_app_splicer_dev->u8_src_sel].u16_vactive > 0 ? g_stVideo_HDRx_Timing[pst_app_splicer_dev->u8_src_sel].u16_vactive : 1080;
...
VOID app_splicer_osd_config(VOID)
{
	...
	for(u8_idx = 0; u8_idx < 4; u8_idx ++)
	{
		...
		st_font.u8_y = 0;
		st_font.pu16_idx = (UINT16 *)str_osd_input_channel[gst_splicer_app_dev.u8_src_sel];
		...
		st_str.u8_y = 3;
		set_osd_res(gst_splicer_app_dev.u8_src_sel);
		st_str.u16_len = 15;
